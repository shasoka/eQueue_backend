...
class Group(Base):
    """
    Модель, описывающая сущность группы.
...
class Workspace(Base):
    """
    Модель, описывающая сущность рабочего пространства.
    Соответствует таблице `workspaces`.
    """
...
class WorkspaceMember(Base):
    """
    Модель, описывающая сущность члена рабочего пространства.
    Соответствует таблице `workspace_members`.
    """
...
class Subject(Base):
    """
    Модель, описывающая сущность предмета.
    Соответствует таблице `subjects`.
    """
...
class Queue(Base):
    """
    Модель, описывающая сущность очереди.
    Соответствует таблице `queues`.
    """
...
class QueueMember(Base):
    """
    Модель, описывающая сущность члена очереди.
    Соответствует таблице `queue_members`.
    """
...
class Task(Base):
    """
    Модель, описывающая сущность задания.
    Соответствует таблице `tasks`.
    """
...
class Submission(Base):
    """
    Модель, описывающая сущность сдачи задания.
    Соответствует таблице `submissions`.
    """
